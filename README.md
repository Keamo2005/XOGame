...
The **XO Game is a mobile application developed as part of an assignment in the MAST5112 subject. This application was created using **Kotlin** and **Visual Studio**. The app's primary purpose is to create a tic-tact-toe game.
...
### Purpose:
The main goal of this app is to create a tic-tac-toe game.

### Key Features:
- Feature 1: Collecting two player names before a game can begin.
- Feature 2: Uses navigation
- Feature 3: Error Handling

These features aim to provide an easy-to-use game. 

---

## Design Considerations

The design of the **Campsite Commander** was based on the following key considerations:
...
1. **Challenge 1**: Old version couldn't work with code
   - **Solution**: Update Expo Go
   
2. **Challenge 2**: App couldn't open after updating
   - **Solution**: None
